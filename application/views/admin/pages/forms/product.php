                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    ?>
                                                                    <select class="form-control city_list" name="deliverable_cities[]" id="deliverable_cities" multiple <?= (isset($product_details[0]['deliverable_type']) && ($product_details[0]['deliverable_type'] == INCLUDED || $product_details[0]['deliverable_type'] == EXCLUDED)) ? "" : "disabled" ?>>
