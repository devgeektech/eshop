                        ...
                        <div class="card-header border-0">
                            <div class="col-md-3">
                                ...
                                <select class='form-control' name='category_parent' id="category_parent">
                                    <option value=""><?= !empty($this->lang->line('select_category')) ? $this->lang->line('select_category') : '<?= !empty($this->lang->line('select_category')) ? $this->lang->line('select_category') : 'Select Category' ?>' ?></option>
